...
class RealHATGANModel(SRGANModel):
    ...
    def __init__(self, opt):
        ...
        self.use_gp = opt['train']['gan_opt'].get('use_gp', False)
        if self.use_gp:
            self.gp_lambda = opt['train']['gan_opt'].get('gp_lambda', 10)
    ...
    def optimize_parameters(self, current_iter):
        ...
        if self.use_gp:
            gp_loss = gradient_penalty_loss(self.net_d, gan_gt, self.output, self.gp_lambda)
            gp_loss.backward()
            loss_dict['gp_loss'] = gp_loss
