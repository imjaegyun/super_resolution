...
class HierarchicalTransformerBlock(nn.Module):
    ...
    def forward(self, x, x_size, win_size):
        ...
        x = x + self.drop_path(self.after_mlp(self.norm2(self.mlp(x, x_size))))
...
class HiT_SRF(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 use_checkpoint=False, upscale=4, img_range=1., upsampler='noupsample', resi_connection='1conv',
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            self.conv_last = nn.Conv2d(embed_dim, embed_dim, 3, 1, 1)
            pass
    ...
    def forward(self, x):
        ...
        else:  # This path is used for Arbitrary-Scale SR !!!
